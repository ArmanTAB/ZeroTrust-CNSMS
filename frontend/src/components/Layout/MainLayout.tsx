    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="hidden md:flex md:flex-col md:w-64 md:fixed md:inset-y-0 z-10">
        <div className="flex flex-col flex-grow bg-gradient-to-b from-blue-800 to-blue-900 overflow-y-auto">
          <div className="flex items-center justify-center h-16 bg-blue-900 bg-opacity-40">
          ...
          <nav className="flex-1 px-2 py-4 space-y-1">
            ...
            >
              <svg
                className={`flex-shrink-0 w-6 h-6 mr-3 transition-colors duration-200 ${
                  isActiveRoute("/dashboard")
                    ? "text-white"
          ...
          <div className="p-4 bg-blue-900 bg-opacity-40">
            <div className="flex items-center">
              <div
            ...
            <button
              ...
              className="mt-3 w-full flex items-center justify-center px-4 py-2 text-sm text-white bg-blue-700 bg-opacity-50 rounded-md hover:bg-blue-600 transition-colors duration-200"
            >
              <svg
