// Modify frontend/src/pages/GoogleDrive/GoogleDrivePage.tsx
...
const GoogleDrivePage: React.FC = () => {
  ...
  const fetchAccessRequests = async () => {
    ...
    setLoading(true);
    try {
      const requests = await AccessApi.getDriveAccessRequests();
  ...
  const handleRequestAccess = async (folderId: string, folderName: string) => {
    ...
    try {
      ...
      // Always show the "pending approval" message
  ...
  const handleRejectRequest = async () => {
    ...
    try {
      const result = await AccessApi.rejectDriveAccess(
        selectedRequest.id,
        rejectReason
      );
  ...
  return (
    <MainLayout>
      ...
      {loading ? (
            ...
            >
              <div className="p-6">
                ...
                <button
                  ...
                  disabled={
                    accessRequesting === folder.id || folder.hasPendingRequest
                  }
        ...
        // Access Requests Tab (Admin view)
