// src/pages/Auth/RegisterPage.tsx (complete updated version)
...
const RegisterPage: React.FC = () => {
  const [formData, setFormData] = useState({
    ...
    confirmPassword: "",
    full_name: "",
    role: UserRole.NETWORK_ADMIN, // Default to NETWORK_ADMIN now that VIEWER is removed
  });
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <select
                      ...
                      onChange={handleChange}
                    >
                      {/* Only showing the available roles (without VIEWER) */}
                      <option value={UserRole.ADMIN}>Admin</option>
                      <option value={UserRole.SECURITY_ANALYST}>
                        Security Analyst
                      </option>
                      <option value={UserRole.NETWORK_ADMIN}>
                        Network Admin
                      </option>
                    </select>
                  </div>
