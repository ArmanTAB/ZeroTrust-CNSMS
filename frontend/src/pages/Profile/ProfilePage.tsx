...
const ProfilePage: React.FC = () => {
  ...
  const handleSetupTOTP = async () => {
    ...
    try {
      ...
      console.log("TOTP Setup Response:", response); // Add this for debugging

      // Make sure you're correctly setting the data from the response
              ...
              {setupStep === "verify" && setupData && (
                <div>
                  <div className="text-sm text-gray-600 mb-4">
                    ...
                    <div className="flex justify-center my-4">
                      {setupData.qr_code ? (
                        <img
                          ...
                          style={{ width: "180px", height: "180px" }} // Add this line to control size
                        />
                      ) : (
                    ...
                    <p>
                      After scanning the QR code or entering the code manually,
                      enter the 6-digit verification code from your
                      authentication app below:
                    </p>
                  </div>
