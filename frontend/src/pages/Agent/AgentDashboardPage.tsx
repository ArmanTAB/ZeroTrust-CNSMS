  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      ...
      try {
        ...
        // Fetch recent activities - specifically request 10 recent activities
        const activities = await AgentApi.getActivities({
          limit: 10,
          skip: 0,
        });

        console.log("Fetched agent activities:", activities); // Debug log
